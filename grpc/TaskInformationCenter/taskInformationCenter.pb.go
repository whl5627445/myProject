...
type TaskInformationRequest struct {
	...
	SimulateResult    map[string]*Variable `protobuf:"bytes,20,rep,name=simulateResult,proto3" json:"simulateResult,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // 结果map
...
type GetPackageFinishedTaskResponse struct {
	...
	SimulateResult    map[string]*Variable `protobuf:"bytes,6,rep,name=simulateResult,proto3" json:"simulateResult,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // 结果map
