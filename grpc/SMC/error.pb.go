...
type ErrorMessage struct {
	...
	Level         string                 `protobuf:"bytes,1,opt,name=level,proto3" json:"level,omitempty"`      // 消息等级
...
func (x *ErrorMessage) GetLevel() string {
	if x != nil {
		return x.Level
	}
	return ""
...
var file_error_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x09, 0x73,
	0x6d, 0x63, 0x2e, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x3e, 0x0a, 0x0c, 0x65, 0x72, 0x72, 0x6f,
	0x72, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x65, 0x76, 0x65,
	...
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0x0b, 0x5a, 0x09, 0x2e, 0x2f, 0x53, 0x4d,
	0x43, 0x3b, 0x73, 0x6d, 0x63, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_error_proto_goTypes = []any{
	(*ErrorMessage)(nil), // 0: smc.error.errorMessage
}
