...
var file_router_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xe4, 0x02, 0x0a, 0x16, 0x50, 0x79, 0x4f,
	...
	0x6f, 0x6e, 0x50, 0x72, 0x61, 0x44, 0x61, 0x74, 0x61, 0x1a, 0x44, 0x0a, 0x16, 0x53, 0x69, 0x6d,
...
var file_router_proto_depIdxs = []int32{
	...
	0,  // 4: Greeter.FmuSimulation:input_type -> FmuSimulationRequest
	2,  // 5: Greeter.GetProcessStatus:input_type -> GetProcessStatusRequest
	4,  // 6: Greeter.GetAllProcessNumber:input_type -> GetAllProcessNumberRequest
	...
	12, // 10: Greeter.MatToCsv:input_type -> MatToCsvRequest
	14, // 11: Greeter.ZarrToCsv:input_type -> ZarrToCsvRequest
	16, // 12: Greeter.CheckVarExist:input_type -> CheckVarExistRequest
	18, // 13: Greeter.PyOmcSimulation:input_type -> PyOmcSimulationRequest
	1,  // 14: Greeter.FmuSimulation:output_type -> FmuSimulationReply
	3,  // 15: Greeter.GetProcessStatus:output_type -> GetProcessStatusReply
	5,  // 16: Greeter.GetAllProcessNumber:output_type -> GetAllProcessNumberReply
	7,  // 17: Greeter.GetResult:output_type -> GetResultReply
	9,  // 18: Greeter.ProcessOperation:output_type -> ProcessOperationReply
	11, // 19: Greeter.ReadSimulationResult:output_type -> ReadSimulationResultReply
	13, // 20: Greeter.MatToCsv:output_type -> MatToCsvReply
	15, // 21: Greeter.ZarrToCsv:output_type -> ZarrToCsvReply
	17, // 22: Greeter.CheckVarExist:output_type -> CheckVarExistReply
	19, // 23: Greeter.PyOmcSimulation:output_type -> PyOmcSimulationReply
